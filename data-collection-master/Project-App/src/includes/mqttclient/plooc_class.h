...
// #   define PLOOC_ALIGNOF_STRUCT(...)  1
//                         // ({ \
//                         // typedef struct {__VA_ARGS__}PLOOC_CONNECT4(_alignof,__LINE__,__LINE__,_chMask); \
//                         // (PLOOC_ALIGNOF(PLOOC_CONNECT4(_alignof,__LINE__,__LINE__,_chMask))); })

// #   define PLOOC_SIZEOF_STRUCT(...)  \
// //  ({ \
// //  typedef struct {__VA_ARGS__}PLOOC_CONNECT4(_sizeof,__LINE__,__LINE__,_chMask); \
// //     (sizeof(PLOOC_CONNECT4(_alignof,__LINE__,__LINE__,_chMask)));\
// //  })\
...
typedef struct {__VA_ARGS__}PLOOC_CONNECT4(__mm,__LINE__,__LINE__,_chMask);  \
        uint8_t PLOOC_CONNECT4(_,__LINE__,__COUNTER__,_chMask)                  \
                [sizeof(PLOOC_CONNECT4(__mm,__LINE__,__LINE__,_chMask))]                              \
                PLOOC_ALIGN(PLOOC_ALIGNOF(PLOOC_CONNECT4(__mm,__LINE__,__LINE__,_chMask)));
